 ...
 * that will visit/modify a [KotlinAnonymousClassSpecBuilder].
 */
@ExperimentalKotlinPoetApi
abstract class KotlinAnonymousClassSpecProcessor<CONTEXT : KotlinCodeGenerationContext<CONTEXT>, INPUT : Any>(
  contextType: KClass<CONTEXT>,
  inputType: KClass<INPUT>,
  order: Int = KotlinCodeGenerationSpi.DEFAULT_ORDER
) : KotlinCodeGenerationProcessorBase<CONTEXT, INPUT, KotlinAnonymousClassSpecBuilder>(
