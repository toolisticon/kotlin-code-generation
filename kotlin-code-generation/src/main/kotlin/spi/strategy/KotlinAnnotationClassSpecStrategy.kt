 ...
 * that will generate a [KotlinAnnotationClassSpec].
 */
@ExperimentalKotlinPoetApi
abstract class KotlinAnnotationClassSpecStrategy<CONTEXT : KotlinCodeGenerationContext<CONTEXT>, INPUT : Any>(
  contextType: KClass<CONTEXT>,
  override val inputType: KClass<INPUT>,
  order: Int = KotlinCodeGenerationSpi.DEFAULT_ORDER,
) : KotlinCodeGenerationStrategyBase<CONTEXT, INPUT, KotlinAnnotationClassSpec>(
  contextType = contextType,
  inputType = inputType,
  specType = KotlinAnnotationClassSpec::class,
  order = order
) {
